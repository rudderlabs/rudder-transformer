const data = [
    ...
    },
    {
        ...
        "destination": {"Config":{"apiKey":"34d8efa09c5b048bbacc6af157f2e687","applicationId":"O2YARRI15I","eventTypeSettings":[]}},
        "error": "Either filters or  objectIds is required.", "statTags": {
        "destType": "ALGOLIA",
    ...
    },
    {
        ...
        "destination": {"Config":{"apiKey":"34d8efa09c5b048bbacc6af157f2e687","applicationId":"O2YARRI15I","eventTypeSettings":[]}},
        "error": "eventType is mandatory for track call", "statTags": {
        "destType": "ALGOLIA",
        "errorCategory": "dataValidation",
        "errorType": "instrumentation",
        "feature": "processor",
    ...
    },
    {
        ...
        "destination": {"Config":{"apiKey":"34d8efa09c5b048bbacc6af157f2e687","applicationId":"O2YARRI15I","eventTypeSettings":[{"from":"product list viewed","to":"click"}]}},
        "error": "for click eventType either both positions and queryId should be present or none", "statTags": {
        "destType": "ALGOLIA",
        "errorCategory": "dataValidation",
        "errorType": "instrumentation",
        "feature": "processor",
    ...
    },
    {
        ...
        "destination": {"Config":{"apiKey":"34d8efa09c5b048bbacc6af157f2e687","applicationId":"O2YARRI15I","eventTypeSettings":[{"from":"product list viewed","to":"check"}]}},
        "error": "eventType can be either click, view or conversion", "statTags": {
        "destType": "ALGOLIA",
        "errorCategory": "dataValidation",
        "errorType": "instrumentation",
        "feature": "processor",
    ...
    },
    {
        ...
        "destination": {"Config":{"apiKey":"34d8efa09c5b048bbacc6af157f2e687","applicationId":"O2YARRI15I"}},
        "error": "eventType is mandatory for track call", "statTags": {
        "destType": "ALGOLIA",
        "errorCategory": "dataValidation",
        "errorType": "instrumentation",
    ...
    },
    {
        ...
        "destination": {"Config":{"apiKey":"34d8efa09c5b048bbacc6af157f2e687","applicationId":"O2YARRI15I","eventTypeSettings":[{"from":"product clicked","to":"cLick "}]}},
        "error": "Missing required value from \"properties.index\"", "statTags": {
        "destType": "ALGOLIA",
        "errorCategory": "dataValidation",
        "errorType": "instrumentation",
        "feature": "processor",
