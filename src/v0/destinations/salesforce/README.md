...
| `mapProperties`      | boolean | `true`  | Both                  | Map RudderStack traits to standard Salesforce fields via config JSONs. When disabled, traits are sent as-is. `mapProperty` is read as a fallback. |
