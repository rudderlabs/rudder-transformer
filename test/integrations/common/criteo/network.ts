...
export const networkCallsData = [
  {
    ...
    httpReq: {
      url: 'https://api.criteo.com/2026-07/audiences/3485/contactlist/expiredAccessToken',
      data: commonData,
      params,
      headers,
      method,
  ...
  },
  {
    ...
    httpReq: {
      url: 'https://api.criteo.com/2026-07/audiences/34895/contactlist/invalidAccessToken',
      data: commonData,
      params,
      headers,
      method,
