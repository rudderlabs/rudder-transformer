...
const { RUDDER_ECOM_MAP,
    ...
    INTEGERATION,
    SHOPIFY_TRACK_MAP } = require('./config');
const { RedisDB } = require('../../../util/redis/redisConnector');
const Message = require('../message');
const { EventType } = require('../../../constants');
const stats = require('../../../util/stats');
const { getHashLineItems, createPropertiesForEcomEvent, getProductsListFromLineItems } = require('./commonUtils');
...
const trackLayer = {
     ...
     */
    isValidCartEvent(newCartItems, prevCartItems) { return !(prevCartItems === newCartItems) },
