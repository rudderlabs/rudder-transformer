...
>>>>>>> origin/master
          ...
          data: {
            ...
            context_os_name: "generic_x86_arm",
            context_os_token: "some_device_token",
...
function input(eventType) {
  return { ...sampleEvents[eventType].input };
}

function output(eventType, provider) {
  if (provider === "snowflake") {
    return [...sampleEvents[eventType].output.snowflake];
  }
  return [...sampleEvents[eventType].output.default];
}
