...
export const data = [
  ...
  {
    name: 'fb_custom_audience',
    description: 'Hashing and Format Disabled',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
              ...
              body: {
                JSON: {
                  payload: {
                    ...
                    schema: ['DOBM'],
                    data: [['a953f09a1b6b6725b81956e9ad0b1eb49e3ad40004c04307ef8af6246a054116']],
                  },
                },
                XML: {},
                JSON_ARRAY: {},
  ...
  {
    name: 'fb_custom_audience',
    description: 'Hashing Enabled and Type Unknown',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
  ...
  {
    name: 'fb_custom_audience',
    description: 'Hashing Enabled and Format Disabled with female GEN value',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
