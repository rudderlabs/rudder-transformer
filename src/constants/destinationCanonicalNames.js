...
const DestCanonicalNames = {
  ...
  GOOGLE_ADWORDS_REMARKETING_LISTS: [ 'GOOGLE_ADWORDS_REMARKETING_LISTS', 'google_adwords_remarketing_lists', 'Google Adwords Remarketing Lists', 'google adwords remarketing lists'],
  GOOGLE_ADWORDS_ENHANCED_CONVERSIONS: [ 'GOOGLE_ADWORDS_ENHANCED_CONVERSIONS', 'google_adwords_enhanced_conversions', 'Google Adwords Enhanced Conversions', 'google adwords enhanced conversions'],
  GOOGLE_ADWORDS_OFFLINE_CONVERSIONS: [ 'GOOGLE_ADWORDS_OFFLINE_CONVERSIONS', 'google_adwords_offline_conversions', 'Google Adwords Offline Conversions', 'google adwords offline conversions'],
};
