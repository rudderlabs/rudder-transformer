    ...
    "output": {
      "response": {
        ...
        "body": [{
          ...
          "error": "Missing required value from [\"properties.postID\",\"properties.postId\",\"properties.post.id\"]",
               "statTags": {
                 "destType": "CANNY",
                 "errorCategory": "dataValidation",
                 "errorType": "instrumentation",
    ...
    "output": {
      "response": {
        ...
        "body": [{
          ...
          "error": "Missing required value from [\"properties.boardID\",\"properties.boardId\",\"properties.board.id\"]",
               "statTags": {
                 "destType": "CANNY",
                 "errorCategory": "dataValidation",
                 "errorType": "instrumentation",
