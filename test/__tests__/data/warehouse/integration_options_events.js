      ...
      rs: [
        {
          ...
          data: {
            ...
            _9omega: true,
            camelcase123key: "camel case",
            testmap_nestedmap: JSON.stringify({"n1":"nested prop 1"}),
            tmap_t1: 10,
            tmap_t2: 20,
            testarray: JSON.stringify(["This is","an","array"]),
            context_app_build: "1.0.0",
            context_app_name: "RudderLabs JavaScript SDK",
            context_app_namespace: "com.rudderlabs.javascript",
            context_app_version: "1.0.5",
      ...
      snowflake: [
        {
          ...
          data: {
            ...
            CAMELCASE123KEY: "camel case",
            TESTMAP_NESTEDMAP: JSON.stringify({"n1":"nested prop 1"}),
            TMAP: JSON.stringify({"t1":10,"t2":20}),
            TESTARRAY: JSON.stringify(["This is","an","array"]),
            CONTEXT_APP_BUILD: "1.0.0",
            CONTEXT_APP_NAME: "RudderLabs JavaScript SDK",
            CONTEXT_APP_NAMESPACE: "com.rudderlabs.javascript",
      ...
      bq: [
        ...
        },
        {
          ...
          data: {
            ...
            _9_omega: true,
            camel_case_123_key: "camel case",
            test_map_nested_map: JSON.stringify({"n1":"nested prop 1"}),
            t_map: JSON.stringify({"t1":10,"t2":20}),
            test_array: JSON.stringify(["This is","an","array"]),
            context_app_build: "1.0.0",
            context_app_name: "RudderLabs JavaScript SDK",
            context_app_namespace: "com.rudderlabs.javascript",
            context_app_version: "1.0.5",
