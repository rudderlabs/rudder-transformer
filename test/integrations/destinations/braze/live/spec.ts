...
// backoff layer. 7 attempts (waits 1,2,4,8,16,32s -> reads at ~0,1,3,7,15,31,63s) covers slower
// Braze export lag while staying under the runner's 120s per-scenario timeout.
