import { AUTH_PATTERN_2, SECRET_1, AUTH_PATTERN_4, SECRET_3 } from '../maskedSecrets';
          ...
          input: [
            {
              ...
              metadata: {
                jobId: 1,
                secret: { access_token: SECRET_1, refresh_token: 'myRefreshToken' },
                userId: 'u1',
              },
              message: {
                type: 'identify',
            ...
            },
            {
              ...
              metadata: {
                jobId: 4,
                secret: { access_token: SECRET_3, refresh_token: 'myRefreshToken' },
                userId: 'u1',
              },
              message: {
                type: 'identify',
