...
export const data = [
	...
	{
		"name": "ga4",
		"description": "(gtag) check all property mappings for 'payment info entered' -> 'add_payment_info' event",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "(gtag) check all property mappings for 'checkout Step Completed' -> 'add_shipping_info' event",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "(gtag) send only 'spend_virtual_currency' event name with it's required 'value' and 'virtual_currency_name' properties",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "(gtag) pass custom event name 'rudderstack event' to GA4 along with custom properties",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "(gtag) pass custom event name 'rudderstack event' to GA4 along with custom properties and user_properties",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "[Exclusion]: (gtag) pass reserved property name and reserved properties in `user_properties` to GA4 for custom events",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "(gtag) pass event name with invalid data type for products: {...} properties (when products parameter is optional)",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "[Error] (gtag) pass event name to GA4 with missing fields i.e required in products: [..]",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "[Error] (gtag) pass event name to GA4 with missing fields i.e required in properties",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "(gtag) pass custom properties along with products: [..] parameters to GA4 standard events along with its stated ones",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "(gtag) pass custom properties excluding products: [..] parameter to GA4 standard events along with its stated ones",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "(gtag): take page properties from context.page for 'page' call along with custom properties",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "client_id isn't sent from the path defined in the webapp config, falling back to default values i.e here it is anonymousId",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "any custom or item property with array value, is flattened with underscore delimeter",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "(gtag) track event with hybrid connection mode using buffer cloud mode event approach",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	{
		"name": "ga4",
		"description": "(gtag) track event with hybrid connection mode using override client_id and session_id approach",
		"feature": "processor",
		"module": "destination",
		"version": "v0",
		"input": {
	...
	},
	{
		...
		"output": {
			"response": {
				...
				"body": [
					{
						"error": "Event name must start with a letter and can only contain letters, numbers, and underscores",
						"statTags": {
							"destType": "GA4",
							"errorCategory": "dataValidation",
							"errorType": "instrumentation",
