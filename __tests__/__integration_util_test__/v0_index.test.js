...
const formDataEscapeCases = [
  // This case is added because url.Values{}.Encode() encodes all the special characters
  {
    ...
    input: { data: " ?&=#+%!<>#\"{}|\\^[]`☺\t:/@$'()*,;" },
    expected: "data=+%3F%26%3D%23%2B%25%21%3C%3E%23%22%7B%7D%7C%5C%5E%5B%5D%60%E2%98%BA%09%3A%2F%40%24%27%28%29*%2C%3B"
  },
  {
    ...
    expected: "data=Channel+is+*san_dev*+which+is+being+viewed+by+%60Sank%60%2C+you+don%27t+have+_control_+over%0A%60%60%60This+code-snippet+does+the+trick+for+us%60%60%60"
  },
  {
