...
export const data = [
  ...
  {
    name: 'impact',
    description: 'Identify Call with CustomerEmail as number - should not hash',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
  ...
  {
    name: 'impact',
    description: 'Identify Call with CustomerEmail as object - should not hash',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
        ...
        body: [
          {
            message: {
              ...
              context: {
                ...
                traits: {
                  email: { primary: 'user123@email.com', secondary: 'user456@email.com' },
                  phone: '+917836362334',
                  userId: 'user123',
                },
                locale: 'en-US',
            ...
            output: {
              body: {
                ...
                FORM: {
                  ...
                  ImpactAppId: '2323',
                  DeviceLocale: 'en-US',
                  CustomerEmail: { primary: 'user123@email.com', secondary: 'user456@email.com' },
                  CustomProfileId: '97c46c81-3140-456d-b2a9-690d70aaca35',
                },
                JSON: {},
                JSON_ARRAY: {},
  ...
  {
    name: 'impact',
    description: 'Identify Call with CustomerEmail as array - should not hash',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
        ...
        body: [
          {
            message: {
              ...
              context: {
                ...
                traits: {
                  email: ['user123@email.com', 'user456@email.com'],
                  phone: '+917836362334',
                  userId: 'user123',
                },
                locale: 'en-US',
            ...
            output: {
              body: {
                ...
                FORM: {
                  ...
                  ImpactAppId: '2323',
                  DeviceLocale: 'en-US',
                  CustomerEmail: ['user123@email.com', 'user456@email.com'],
                  CustomProfileId: '97c46c81-3140-456d-b2a9-690d70aaca35',
                },
                JSON: {},
                JSON_ARRAY: {},
  ...
  {
    name: 'impact',
    description: 'Identify Call with CustomerEmail as boolean - should not hash',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
