    ...
    "output": {
      "response": {
        ...
        "body": {
          "output": {
            "status": 500,
            "message": "Salesforce Request Failed - due to \"INVALID_SESSION_ID\", (Retryable) during Salesforce Response Handling",
            "destinationResponse": {
              "response": [
                {
    ...
    "output": {
      "response": {
        ...
        "body": {
          "output": {
            "status": 400,
            "message": "Salesforce Request Failed: \"401\" due to \"INVALID_HEADER_TYPE\", (Aborted) during Salesforce Response Handling",
            "destinationResponse": {
              "response": [
                {
    ...
    "output": {
      "response": {
        ...
        "body": {
          "output": {
            "status": 429,
            "message": "Salesforce Request Failed - due to \"REQUEST_LIMIT_EXCEEDED\", (Throttled) during Salesforce Response Handling",
            "destinationResponse": {
              "response": [
                {
    ...
    "output": {
      "response": {
        ...
        "body": {
          "output": {
            "status": 500,
            "message": "Salesforce Request Failed - due to \"Server Unavailable\", (Retryable) during Salesforce Response Handling",
            "destinationResponse": {
              "response": [
                {
    ...
    "output": {
      "response": {
        ...
        "body": {
          "output": {
            "status": 400,
            "message": "Salesforce Request Failed: \"400\" due to \"{\"error\":\"invalid_grant\",\"error_description\":\"authentication failure\"}\", (Aborted) during Salesforce Response Handling",
            "destinationResponse": {
              "response": {
                "error": "invalid_grant",
      ...
      "response": {
        ...
        "body": {
          "output": {
            ...
            "message": "Salesforce Request Failed - due to \"{\"message\":\"Server Unavailable\",\"errorCode\":\"SERVER_UNAVAILABLE\"}\", (Retryable) during Salesforce Response Handling",
            "statTags": {
              "destType": "SALESFORCE",
              "errorCategory": "network",
              "destinationId": "Non-determininable",
      ...
      "response": {
        ...
        "body": {
          "output": {
            ...
            "message": "Request for destination: salesforce Processed Successfully",
            "destinationResponse": {
              "response": {"searchRecords":[{"attributes":{"type":"object_name","url":"/services/data/v50.0/sobjects/object_name/a0J75100002w97gEAA"},"Id":"a0J75100002w97gEAA","External_ID__c":"external_id"},{"attributes":{"type":"object_name","url":"/services/data/v50.0/sobjects/object_name/a0J75200002w9ZsEAI"},"Id":"a0J75200002w9ZsEAI","External_ID__c":"external_id TEST"}]},
              "status": 200,
              "rudderJobMetadata": {
                "destInfo": {
                  "authKey": "2HezPl1w11opbFSxnLDEgZ7kWTf"
