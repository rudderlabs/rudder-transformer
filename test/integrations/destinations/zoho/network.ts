...
export const networkCallsData = [
  ...
  {
    httpReq: {
      url: 'https://www.zohoapis.in/crm/v6/Contacts/search?criteria=(Email:equals:tobedeleted2%40gmail.com)and(First_Name:equals:subcribed2)and(Last_Name:equals:%20User2)',
      headers: {
        Authorization: 'Zoho-oauthtoken correct-access-token',
      },
      method: 'GET',
