const data = [{
        ...
        "destination": {"Config":{"eventApiKey":"efeb4a29aba5e75d99c8a18acd620ec1","dataCenter":"standard"}},
        "error": "Missing required value from \"groupId\"", "statTags": {
        "destType": "BLUESHIFT",
      ...
      "statusCode": 400
        ...
        "output":{
            "response": {
                ...
                "body": [{
      "output": 
      {"version":"1","type":"REST","method":"POST","endpoint":"https://api.getblueshift.com/api/v1/event","headers":{"Authorization":"Basic ZWZlYjRhMjlhYmE1ZTc1ZDk5YzhhMThhY2Q2MjBlYzE=","Content-Type":"application/json"},"params":{},"body":{"JSON":{"group_id":"35838","customer_id":"rudderstack8","email":"hardik@rudderstack.com","event":"identify"},"JSON_ARRAY":{},"XML":{},"FORM":{}},"files":{},"userId":""}, 
      "statusCode": 200}]
            }
        } 
     },{
        ...
        "output":{
            "response": {
                ...
                "body": [{
      "output": 
      {"body":{"XML":{},"FORM":{},"JSON":{"ip":"14.5.67.21","event":"identify","cookie":"1234abcd-efghijkj-1234kfjadslk-34iu123","os_name":"Android","latitude":"37.7672319","device_id":"3f034872-5e28-45a1-9eda-ce22a3e36d1a","longitude":"-122.4021353","event_uuid":"34abcd-efghijkj-1234kf","customer_id":"sampleusrRudder7","device_idfa":"3f034872-5e28-45a1-9eda-ce22a3e36d1a","device_idfv":"3f034872-5e28-45a1-9eda-ce22a3e36d1a","device_type":"Android","network_carrier":"Android","device_manufacturer":"Google"},"JSON_ARRAY":{}},"type":"REST","files":{},"method":"POST","params":{},"headers":{"Content-Type":"application/json","Authorization":"Basic ZWZlYjRhMjlhYmE1ZTc1ZDk5YzhhMThhY2Q2MjBlYzE="},"version":"1","endpoint":"https://api.getblueshift.com/api/v1/event","userId":""}, 
      "statusCode": 200}]
            }
        } 
     },{
      ...
      "statusCode": 200}]
        ...
        "destination": {"Config":{"usersApiKey":"b4a29aba5e75d99c8a18acd920ec1e2e","dataCenter":"standard"}},
        "error": "[BLUESHIFT] event Api Keys required for Authentication.", "statTags": {
        "destType": "BLUESHIFT",
        "errorCategory": "dataValidation",
      ...
      "statusCode": 400
        ...
        "destination": {"Config":{"eventApiKey":"a5e75d99c8a18acb4a29abd920ec1e2e","usersApiKey":"b4a29aba5e75d99c8a18acd920ec1e2e","dataCenter":"standard"}},
        "error": "Missing required value from \"email\"", "statTags": {
        "destType": "BLUESHIFT",
        "errorCategory": "dataValidation",
        "errorType": "instrumentation",
        "feature": "processor",
      ...
      "statusCode": 200}]
        ...
        "destination": {"Config":{"eventApiKey":"a5e75d99c8a18acb4a29abd920ec1e2e","dataCenter":"eu"}},
        "error": "[BLUESHIFT] User API Key required for Authentication.", "statTags": {
        "destType": "BLUESHIFT",
        "errorCategory": "dataValidation",
        "errorType": "configuration",
        "feature": "processor",
      ...
      "statusCode": 200}]
        ...
        "destination": {"Config":{"eventApiKey":"a5e75d99c8a18acb4a29abd920ec1e2e","usersApiKey":"b4a29aba5e75d99c8a18acd920ec1e2e","dataCenter":"eu"}},
      ...
      "statusCode": 200}]
        ...
        "destination": {"Config":{"eventApiKey":"efeb4a29aba5e75d99c8a18acd620ec1","usersApiKey":"b4a29aba5e75duic8a18acd920ec1e2e","dataCenter":"eu"}},
        "error": "[Blueshift] Event shouldn't contain period(.), numeric value and contains not more than 64 characters", "statTags": {
        "destType": "BLUESHIFT",
        "errorCategory": "dataValidation",
        "errorType": "instrumentation",
        "feature": "processor",
      ...
      "statusCode": 400
        ...
        "output":{
            "response": {
                ...
                "body": [{
      "output": 
      {"body":{"XML":{},"FORM":{},"JSON":{"group_id":"group22222","customer_id":"sampleusrRudder1","email":"hardik@rudderstack.com","device_type":"android","device_id":"7e32188a4dab669f","device_idfv":"7e32188a4dab669f","device_manufacturer":"Google","os_name":"Android","network_carrier":"Android","event_uuid":"e5034jh0-a404-47b4-a463-76df99934kl2","cookie":"1234abcd-efghklkj-1234kfjadslk-34iu123","event":"identify","name":"hardik","industry":"Education","employees":399,"plan":"enterprise","total billed":830,"gender":"male"},"JSON_ARRAY":{}},"type":"REST","files":{},"method":"POST","params":{},"headers":{"Content-Type":"application/json","Authorization":"Basic ZWZlYjRhMjlhYmE1ZTc1ZDk5YzhhMThhY2Q2MjBlYzE="},"version":"1","endpoint":"https://api.getblueshift.com/api/v1/event","userId":""}, 
      "statusCode": 200}]
            }
        } 
     },{
        ...
        "destination": {"Config":{"usersApiKey":"b4a29aba5e75duic8a18acd920ec1e2e","dataCenter":"eu"}},
        "error": "[BLUESHIFT] event API Key required for Authentication.", "statTags": {
        "destType": "BLUESHIFT",
        "errorCategory": "dataValidation",
        "errorType": "configuration",
        "feature": "processor",
