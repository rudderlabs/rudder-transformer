...
export const data = [
  ...
  },
  {
    name: 'singular',
    description:
      '(Android) Event with limitDataSharing true - data_sharing_options present for /evt',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
        ...
        body: [
          {
            ...
            message: {
              ...
              userId: 'ruddersampleX5',
              request_ip: '14.5.67.21',
              integrations: { Singular: { limitDataSharing: true } },
              context: {
                app: {
                  build: '1',
                  name: 'RudderAndroidClient',
        ...
        body: [
          {
            output: {
              ...
              params: {
                ...
                partner: 'rudderstack',
                c: 'wifi',
                data_sharing_options: { limit_data_sharing: true },
                e: {
                  url: 'myapp%3A%2F%2Fhome%2Fpage%3Fqueryparam1%3Dvalue1',
                  install: 'SM-G935F',
                  category: 'Games',
  ...
  },
  {
    name: 'singular',
    description:
      '(Android) Event with limitDataSharing false - data_sharing_options present for /evt',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
        ...
        body: [
          {
            ...
            message: {
              ...
              userId: 'ruddersampleX5',
              request_ip: '14.5.67.21',
              integrations: { Singular: { limitDataSharing: false } },
              context: {
                app: {
                  build: '1',
                  name: 'RudderAndroidClient',
        ...
        body: [
          {
            output: {
              ...
              params: {
                ...
                partner: 'rudderstack',
                c: 'wifi',
                data_sharing_options: { limit_data_sharing: false },
                e: {
                  url: 'myapp%3A%2F%2Fhome%2Fpage%3Fqueryparam1%3Dvalue1',
                  install: 'SM-G935F',
                  category: 'Games',
  ...
  },
  {
    name: 'singular',
    description:
      '(Android) Session event with limitDataSharing true - data_sharing_options present for /launch',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
  ...
  },
  {
    name: 'singular',
    description:
      '(Android) Revenue events with limitDataSharing true - data_sharing_options on each /evt',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
  ...
  },
  {
    name: 'singular',
    description:
      '(Android) V2 Event with singularDeviceId - /v2/evt, sdid only, no platform device ids',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
        ...
        body: [
          {
            ...
            message: {
              ...
              userId: 'ruddersampleX5',
              request_ip: '14.5.67.21',
              integrations: { Singular: { singularDeviceId: 'test-sdid-v2-12345' } },
              context: {
                app: {
                  build: '1',
                  name: 'RudderAndroidClient',
  ...
  {
    name: 'singular',
    description: '(Android) V2 Event with singularDeviceId + limitDataSharing true',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
        ...
        body: [
          {
            ...
            message: {
              ...
              request_ip: '14.5.67.21',
              integrations: {
                Singular: { singularDeviceId: 'test-sdid-v2-67890', limitDataSharing: true },
              },
              context: {
                app: {
                  build: '1',
  ...
  {
    name: 'singular',
    description: '(Android) Session event with singularDeviceId - still V1 /launch',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
        ...
        body: [
          {
            destination: {
              Config: {
                ...
                sessionEventList: [
                  { sessionEventName: 'mysessionevent' },
                  { sessionEventName: 'application opened' },
                  { sessionEventName: 'titanium' },
                ],
              },
            },
            message: {
              ...
              userId: 'ruddersampleX3',
              request_ip: '14.5.67.21',
              integrations: { Singular: { singularDeviceId: 'session-sdid-xyz' } },
              context: {
                app: {
                  build: '1',
                  name: 'RudderAndroidClient',
              ...
              properties: { url: '', referring_application: '', install: false },
              timestamp: '2021-09-01T15:46:51.000Z',
            },
          },
        ],
        ...
        body: [
          {
            output: {
              ...
              params: {
                ...
                c: 'wifi',
                dnt: 0,
                sessionNotificationName: 'application opened',
                custom_user_id: 'ruddersampleX3',
                n: 'RudderAndroidClient',
                fcm: 'testDeviceToken',
                install: false,
  ...
  {
    name: 'singular',
    description: '(Android) V2 Revenue events with singularDeviceId - each to /v2/evt with sdid',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
        ...
        body: [
          {
            ...
            message: {
              ...
              userId: 'ruddersampleX4',
              request_ip: '14.5.67.21',
              integrations: { Singular: { singularDeviceId: 'revenue-sdid-v2' } },
              context: {
                app: {
                  build: '1',
                  name: 'RudderAndroidClient',
              ...
              properties: {
                currency: 'USD',
                products: [
                  { product_id: '789', sku: 'G-32', name: 'Monopoly', price: 14, quantity: 1 },
                  { sku: 'F-32', name: 'UNO', price: 3.45, quantity: 2, category: 'Games' },
                ],
              },
              timestamp: '2021-09-01T15:46:51.000Z',
  ...
  {
    name: 'singular',
    description: '(iOS) V2 Event with singularDeviceId - /v2/evt, sdid only, no idfa/idfv',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
        ...
        body: [
          {
            ...
            message: {
              ...
              userId: 'ruddersampleX5',
              request_ip: '14.5.67.21',
              integrations: { Singular: { singularDeviceId: 'ios-sdid-v2-xyz' } },
              context: {
                app: {
                  build: '1',
                  name: 'RudderAndroidClient',
  ...
  {
    name: 'singular',
    description: '(Unity) V2 Event with singularDeviceId - /v2/evt, sdid only',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
        ...
        body: [
          {
            ...
            message: {
              ...
              userId: 'ruddersampleX4',
              request_ip: '14.5.67.21',
              integrations: { Singular: { singularDeviceId: 'unity-sdid-v2-xyz' } },
              context: {
                app: {
                  build: '1',
                  name: 'RudderAndroidClient',
