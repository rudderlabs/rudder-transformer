const data = [
    ...
    {
      "name": "discord",
      "description": "Identify Call with Default Template with whitelist Traits and default embed Message",
      "feature": "processor",
      "module": "destination",
      "version": "v0",
      "input": {
        ...
        "response": {
          ...
          "body": [{
            ...
            "output": {
              ...
              "body": {
                "JSON": {
                  "content": "my-name-1 having country: USA email: test@domain.com hiji: hulala-1 name: my-name-1  has been identified"
                },
                "XML": {},
                "JSON_ARRAY": {},
                "FORM": {}
        ...
        "response": {
          ...
          "body": [{
            ...
            "output": {
              ...
              "body": {
                "JSON": {
                  "content": "Identified my-name-3 with country: USA email: test@domain.com hiji: hulala-1 name: my-name-3 "
                },
                "XML": {},
                "JSON_ARRAY": {},
                "FORM": {}
    ...
    {
        "name": "discord",
        "description": "track Call with multiple userTemplate for a single channel with properties.keys with Title Template",
        "feature": "processor",
        "module": "destination",
        "version": "v0",
        "input": {
    ...
    {
        "name": "discord",
        "description": "track Call with one userTemplate for one channel with whitelist traits and regex as false with embed",
        "feature": "processor",
        "module": "destination",
        "version": "v0",
        "input": {
        ...
        "response": {
          ...
          "body": [{
            ...
            "output": {
              ...
              "body": {
                "JSON": {
                  "content": "Anonymous user A1 did test_eventing_test with currency: USD key1: test_val1 key2: test_val2 revenue: 30 user_actual_id: 12345 "
                },
                "XML": {},
                "JSON_ARRAY": {},
                "FORM": {}
