        ...
        "output": {
            "response": {
                ...
                "body": [
                    {
                        "statusCode": 500,
                        "error": "{\"message\":\"Request Failed for marketo, Access Token Expired (Retryable).During fetching auth token\",\"destinationResponse\":{\"access_token\":\"access_token_expired\",\"expires_in\":0,\"scope\":\"integrations@rudderstack.com\",\"token_type\":\"bearer\"}}",
                        "statTags": {
        ...
        "output": {
            "response": {
                ...
                "body": [
                    {
                        "statusCode": 500,
                        "error": "{\"message\":\"Request Failed for marketo, Access Token Expired (Retryable).During fetching auth token\",\"destinationResponse\":{\"response\":{\"success\":false,\"errors\":[{\"code\":\"601\",\"message\":\"Access Token Expired\"}]},\"status\":200}}",
                        "statTags": {
                            "errorCategory": "network",
                            "errorType": "retryable",
                            "destType": "MARKETO",
