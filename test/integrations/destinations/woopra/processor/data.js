const data = [{
          ...
          "statusCode": 200}]
            ...
            "input": {
                "request": {
                    "body": [
                        {"message":{"anonymousId":"21e13f4bc7ceddad","channel":"mobile","event":"First Investment","integrations":{"woopra":"int.com"},"type":"group"},"destination":{"Config":{"projectName":"int.com"}}},
                    ],
                    "method": "POST",
                },
                "pathSuffix": "",
            ...
            "error": "Message type group is not supported", "statTags": {
            "destType": "WOOPRA",
          ...
          "statusCode": 400
            ...
            "input": {
                "request": {
                    "body": [
                        {"message":{"anonymousId":"21e13f4bc7ceddad","channel":"mobile","integrations":{"woopra":"int.com"},"type":"track"},"destination":{"Config":{"projectName":"int.com"}}},
                    ],
                    "method": "POST",
                },
                "pathSuffix": "",
            ...
            "destination": {"Config":{"projectName":"int.com"}},
            "error": "Event Name can not be empty", "statTags": {
            "destType": "WOOPRA",
            "errorCategory": "dataValidation",
            "errorType": "instrumentation",
            "feature": "processor",
