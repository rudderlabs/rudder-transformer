...
export const networkCallsData = [
    {
        httpReq: {
            ...
            data: { "job": { "storeSalesMetadata": { "custom_key": "CUSTOM_KEY", "loyaltyFraction": 1, "transaction_upload_fraction": "1" }, "type": "STORE_SALES_UPLOAD_FIRST_PARTY" } },
            headers: { "Authorization": "Bearer abcd1234", "Content-Type": "application/json", "developer-token": "ijkl91011", "login-customer-id": "logincustomerid" },
            method: 'POST',
        },
        httpRes: {
            "data": {
    ...
    },
    {
        httpReq: {
            ...
            headers: { "Authorization": "Bearer abcd1234", "Content-Type": "application/json", "developer-token": "ijkl91011" },
            method: 'POST',
            params: { destination: 'google_adwords_offline_conversion' },
        },
        httpRes: {
    ...
    },
    {
        httpReq: {
            ...
            data: { "conversions": [{ "gbraid": "gbraid", "wbraid": "wbraid", "externalAttributionData": { "externalAttributionCredit": 10, "externalAttributionModel": "externalAttributionModel" }, "cartData": { "merchantId": 9876, "feedCountryCode": "feedCountryCode", "feedLanguageCode": "feedLanguageCode", "localTransactionCost": 20, "items": [{ "productId": "507f1f77bcf86cd799439011", "quantity": 2, "unitPrice": 50 }] }, "userIdentifiers": [{ "userIdentifierSource": "FIRST_PARTY", "hashedPhoneNumber": "04e1dabb7c1348b72bfa87da179c9697c69af74827649266a5da8cdbb367abcd" }], "conversionEnvironment": "WEB", "gclid": "gclid", "conversionDateTime": "2022-01-01 12:32:45-08:00", "conversionValue": 1, "currencyCode": "GBP", "orderId": "PL-123QR", "conversionAction": "customers/1234567891/conversionActions/848898416", "customVariables": [{ "conversionCustomVariable": "customers/1234567891/conversionCustomVariables/19131634", "value": "value" }] }], "partialFailure": true },
            headers: { "Authorization": "Bearer abcd1234", "Content-Type": "application/json", "developer-token": "ijkl91011" },
            method: 'POST',
            params: { destination: 'google_adwords_offline_conversion' },
        },
    ...
    },
    {
        httpReq: {
            url: 'https://googleads.googleapis.com/v14/customers/1234567891:uploadClickConversions',
            data: { "conversions": [{ "gbraid": "gbraid", "wbraid": "wbraid", "externalAttributionData": { "externalAttributionCredit": 10, "externalAttributionModel": "externalAttributionModel" }, "cartData": { "merchantId": 9876, "feedCountryCode": "feedCountryCode", "feedLanguageCode": "feedLanguageCode", "localTransactionCost": 20, "items": [{ "productId": "507f1f77bcf86cd799439011", "quantity": 2, "unitPrice": 50 }] }, "userIdentifiers": [{ "userIdentifierSource": "FIRST_PARTY", "hashedPhoneNumber": "04e1dabb7c1348b72bfa87da179c9697c69af74827649266a5da8cdbb367abcd" }], "conversionEnvironment": "WEB", "gclid": "gclid", "conversionDateTime": "2022-01-01 12:32:45-08:00", "conversionValue": 1, "currencyCode": "GBP", "orderId": "PL-123QR", "conversionAction": "customers/1234567891/conversionActions/848898416" }], "partialFailure": true },
            headers: { "Authorization": "Bearer abcd1234", "Content-Type": "application/json", "developer-token": "ijkl91011" },
            method: 'POST',
            params: { destination: 'google_adwords_offline_conversion' },
        },
