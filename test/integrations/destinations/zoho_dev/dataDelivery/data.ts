...
import { data as zohoDevData } from '../../zoho/dataDelivery/business';

const updatedTestScenariosForZoho_dev = zohoDevData.map((data) => {
  data.name = 'zoho_dev';
...
export const data: ProxyV1TestData[] = updatedTestScenariosForZoho_dev;
