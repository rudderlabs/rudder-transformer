...
const connectionWithValueBasedAudience: Connection = {
  ...connection,
  config: {
    ...connection.config,
    destination: {
      ...(connection.config.destination || {}),
      isValueBasedAudience: true,
    },
  },
};
...
export const rETLRecordV2RouterInvalidRequestWithLookalikeValue: RouterTransformationRequest = {
  input: [
    {
      destination: destinationV2,
      connection: connection,
...
export const rETLRecordV2RouterRequestWithValueBasedAudience: RouterTransformationRequest = {
  input: [
    {
      destination: destinationV2,
...
export const rETLRecordV2RouterInvalidRequestWithValueBasedAudience: RouterTransformationRequest = {
  input: [
    {
      destination: destinationV2,
      connection: connectionWithValueBasedAudience,
