const data = [{
    ...
    "output": {
        "response": {
            ...
            "body": [{
                ...
                "destination": { "Config": { "apiKey": "da70166e-05a3-4fa2-bb1d-da757fd036b4", "blacklistedEvents": [{ "eventName": "" }], "eventDelivery": true, "eventDeliveryTS": 1665474171943, "eventFilteringOption": "disable", "whitelistedEvents": [{ "eventName": "" }] } },
    ...
    "input": {
        "request": {
            "body": [
                { "message": { "type": "identify", "sentAt": "2022-10-11T13:10:54.877+05:30", "context": { "traits": { "age": "30", "city": "Banglore", "phone": "7267286346802347827", "address": { "city": "ahmedabad", "state": "india" }, "lastName": "user", "username": "testUser", "firstName": "test", "userCountry": "india" } }, "rudderId": "caae04c5-959f-467b-a293-86f6c62d59e6", "messageId": "b6ce7f31-5d76-4240-94d2-3eea020ef791", "timestamp": "2022-10-11T13:10:52.137+05:30", "receivedAt": "2022-10-11T13:10:52.138+05:30", "request_ip": "[::1]", "originalTimestamp": "2022-10-11T13:10:54.877+05:30" }, "destination": { "Config": { "apiKey": "da70166e-05a3-4fa2-bb1d-da757fd036b4", "blacklistedEvents": [{ "eventName": "" }], "eventDelivery": true, "eventDeliveryTS": 1665474171943, "eventFilteringOption": "disable", "whitelistedEvents": [{ "eventName": "" }] } } },
            ],
            "method": "POST",
        },
        "pathSuffix": "",
    ...
    "output": {
        "response": {
            ...
            "body": [{
                ...
                "destination": { "Config": { "apiKey": "da70166e-05a3-4fa2-bb1d-da757fd036b4", "blacklistedEvents": [{ "eventName": "" }], "eventDelivery": true, "eventDeliveryTS": 1665474171943, "eventFilteringOption": "disable", "whitelistedEvents": [{ "eventName": "" }] } },
                "error": "At least one of `userId` or `email` is required", "statTags": {
                    "destType": "REFINER",
                    "errorCategory": "dataValidation",
                    "errorType": "instrumentation",
                    "feature": "processor",
    ...
    "output": {
        "response": {
            ...
            "body": [{
                "output":
                    { "body": { "XML": {}, "FORM": { "id": "user@45", "email": "test@user.com", "event": "Product Searched" }, "JSON": {}, "JSON_ARRAY": {} }, "type": "REST", "files": {}, "method": "POST", "params": {}, "headers": { "Content-Type": "application/x-www-form-urlencoded", "Authorization": "Bearer da70166e-05a4-4fa1-bb1c-da757fd036b4" }, "version": "1", "endpoint": "https://api.refiner.io/v1/track", "userId": "" },
                "statusCode": 200
            }]
        }
    }
    ...
    "output": {
        "response": {
            ...
            "body": [{
                "output":
                    { "body": { "XML": {}, "FORM": { "id": "12345", "event": "Viewed pageviewed Page" }, "JSON": {}, "JSON_ARRAY": {} }, "type": "REST", "files": {}, "method": "POST", "params": {}, "headers": { "Content-Type": "application/x-www-form-urlencoded", "Authorization": "Bearer dc70156e-05a3-4fa1-bb1c-da767fd036b4" }, "version": "1", "endpoint": "https://api.refiner.io/v1/track", "userId": "" },
                "statusCode": 200
            }]
        }
    }
