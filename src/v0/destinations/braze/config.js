...
// const BRAZE_BATCH_IDENTIFY_RESOLUTION = process.env.BRAZE_BATCH_IDENTIFY_RESOLUTION === 'true';
const BRAZE_BATCH_IDENTIFY_RESOLUTION = true;
...
module.exports = {
  ...
  BRAZE_BATCH_IDENTIFY_RESOLUTION,
};
