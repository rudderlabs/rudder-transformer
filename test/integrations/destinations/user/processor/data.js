const data = [{
            ...
            "destination": {"Config":{"apiKey":"262fbbda-b85b-48b8-a719-c2fceaf8afaf","appSubdomain":"commander","userEvents":[{"rsEventName":"login","userEventName":"product viewed"}],"companyAttributesMapping":[{"from":"category","to":"companycategory"},{"from":"owner","to":"companyowner"}]}},
          ...
          "statusCode": 400
            ...
            "input": {
                "request": {
                    "body": [
                        {"message":{"userId":"test@123","type":"trackUser","context":{"traits":{"email":"test@rudderstack.com","firstName":"test","lastName":"rudderstack","age":15,"gender":"male","status":"user","city":"Kalkata","country":"india","tags":["productuser"],"phone":"9225467887"},"externalId":[{"type":"userKey","id":"masncbjasbdljajdl"}]},"traits":{"googleUrl":"www.google.com"}},"destination":{"Config":{"apiKey":"262fbbda-b85b-48b8-a719-c2fceaf8afaf","appSubdomain":"commander"}}},
                    ],
                    "method": "POST",
                },
                "pathSuffix": "",
            ...
            "destination": {"Config":{"apiKey":"262fbbda-b85b-48b8-a719-c2fceaf8afaf","appSubdomain":"commander"}},
            "error": "Event type trackuser is not supported", "statTags": {
            "destType": "USER",
            "errorCategory": "dataValidation",
            "errorType": "instrumentation",
            "feature": "processor",
          ...
          "statusCode": 400
            ...
            "input": {
                "request": {
                    "body": [
                        {"message":{"userId":"user@123","type":"track","properties":{"category":"e-commerce","activity":"user logged in"},"traits":{"email":"rudderstack@test.com"},"integrations":{"user.com":{"lookup":"email"}},"timestamp":"2020-02-02T00:23:09.544Z"},"destination":{"Config":{"apiKey":"262fbbda-b85b-48b8-a719-c2fceaf8afaf","appSubdomain":"commander"}}},
                    ],
                    "method": "POST",
                },
                "pathSuffix": "",
            ...
            "destination": {"Config":{"apiKey":"262fbbda-b85b-48b8-a719-c2fceaf8afaf","appSubdomain":"commander"}},
            "error": "Parameter event is required", "statTags": {
            "destType": "USER",
            "errorCategory": "dataValidation",
            "errorType": "instrumentation",
            "feature": "processor",
          ...
          "statusCode": 400
            ...
            "input": {
                "request": {
                    "body": [
                        {"message":{"anonymousId":"507f191e810c19729de860ea","channel":"browser","context":{"userAgent":"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.115 Safari/537.36"},"integrations":{"All":true},"messageId":"022bb90c-bbac-11e4-8dfc-aa07a5b093db","receivedAt":"2015-02-23T22:28:55.387Z","sentAt":"2015-02-23T22:28:55.111Z","timestamp":"2015-02-23T22:28:55.111Z","traits":{"email":"business@rudderstack.com","plan":"premium","logins":5,"address":{"street":"6th St","city":"San Francisco","state":"CA","postalCode":"94103","country":"USA"}},"type":"group","userId":"user@123"},"destination":{"Config":{"apiKey":"262fbbda-b85b-48b8-a719-c2fceaf8afaf","appSubdomain":"commander"}}},
                    ],
                    "method": "POST",
                },
                "pathSuffix": "",
            ...
            "destination": {"Config":{"apiKey":"262fbbda-b85b-48b8-a719-c2fceaf8afaf","appSubdomain":"commander"}},
            "error": "Parameter name is required", "statTags": {
            "destType": "USER",
            "errorCategory": "dataValidation",
            "errorType": "instrumentation",
            "feature": "processor",
          ...
          "statusCode": 400
            ...
            "input": {
                "request": {
                    "body": [
                        {"message":{"userId":"test@16","type":"identify","context":{"traits":{"email":"test@rudderstack.com","firstName":"test","lastName":"rudderstack","age":15,"gender":"male","status":"user","city":"Kalkata","country":"india","tags":["productuser"],"phone":"9225467887","useroccupation":"software engineer"},"externalId":[{"type":"userKey","id":"lel1c5u1wuk8"}]},"traits":{"googleUrl":"www.google.com"}},"destination":{"Config":{"apiKey":"262fbbda-b85b-48b8-a719-c2fceaf8afaf","appSubdomain":"commander","userAttributesMapping":[{"from":"useroccupation","to":"occupation"}]}}},
                    ],
                    "method": "POST",
                },
                "pathSuffix": "",
          ...
          "statusCode": 200}]
            ...
            "input": {
                "request": {
                    "body": [
                        {"message":{"userId":"test@12","type":"identify","context":{"traits":{"email":"test@rudderstack.com","firstName":"test","lastName":"rudderstack","age":15,"gender":"female","status":"visitor","city":"ahmedabad","country":"india","phone":"9225467887","useroccupation":"mechanical engineer"}},"traits":{"googleUrl":"www.google.com"},"integrations":{"All":true,"user.com":{"lookup":"email"}}},"destination":{"Config":{"apiKey":"262fbbda-b85b-48b8-a719-c2fceaf8afaf","appSubdomain":"commander","userAttributesMapping":[{"from":"useroccupation","to":"occupation"}]}}},
                    ],
                    "method": "POST",
                },
                "pathSuffix": "",
            ...
            "output":{
                "response": {
                    ...
                    "body": [{
          "output": 
          {"body":{"XML":{},"FORM":{},"JSON":{"age":15,"email":"test@rudderstack.com","gender":3,"status":1,"country":"india","custom_id":"test@12","last_name":"rudderstack","first_name":"test","google_url":"www.google.com","occupation":"mechanical engineer","phone_number":"9225467887"},"JSON_ARRAY":{}},"type":"REST","files":{},"method":"PUT","params":{},"headers":{"Accept":"*/*;version=2","Content-Type":"application/json","Authorization":"Token 262fbbda-b85b-48b8-a719-c2fceaf8afaf"},"version":"1","endpoint":"https://commander.user.com/api/public/users/59/","userId":""}, 
          "statusCode": 200}]
                }
            } 
         },{
          ...
          "statusCode": 200}]
            ...
            "output":{
                "response": {
                    ...
                    "body": [{
          "output": 
          {"body":{"XML":{},"FORM":{},"JSON":{"user_id":52,"user_custom_id":"user@123"},"JSON_ARRAY":{}},"type":"REST","files":{},"method":"POST","params":{},"headers":{"Accept":"*/*;version=2","Content-Type":"application/json","Authorization":"Token 262fbbda-b85b-48b8-a719-c2fceaf8afaf"},"version":"1","endpoint":"https://commander.user.com/api/public/companies/21/add_member/","userId":""}, 
          "statusCode": 200}]
                }
            } 
         }]; module.exports = {
