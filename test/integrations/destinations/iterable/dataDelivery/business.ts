        ...
        body: generateProxyV1Payload(
          {
            ...
            endpointLabel: 'events/trackBulk',
          },
          metadata,
        ),
        method: 'POST',
        ...
        body: generateProxyV1Payload(
          {
            ...
            endpointLabel: 'users/bulkUpdate',
          },
          metadata,
        ),
        method: 'POST',
        ...
        body: generateProxyV1Payload(
          {
            ...
            endpointLabel: 'users/updateEmail',
          },
          singleMetadata,
        ),
        method: 'POST',
        ...
        body: generateProxyV1Payload(
          {
            ...
            endpointLabel: 'users/registerDeviceToken',
          },
          singleMetadata,
        ),
        method: 'POST',
        ...
        body: generateProxyV1Payload(
          {
            ...
            endpointLabel: 'users/registerBrowserToken',
          },
          singleMetadata,
        ),
        method: 'POST',
