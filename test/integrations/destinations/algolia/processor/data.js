        ...
        body: [
          {
            ...
            destination: {
              Config: {
                apiKey: '34d8efa09c5b048bbacc6af157f2e687',
                applicationId: 'O2YARRI15I',
                eventTypeSettings: [{ from: 'product list viewed', to: 'click' }],
              },
            },
          },
        ],
        ...
        body: [
          {
            message: {
              ...
              userId: 'testuserId1',
              event: 'product clicked',
              properties: { index: 'products', queryId: '43b15df305339e827f0ac0bdc5ebcaa7' },
              integrations: { All: true },
              sentAt: '2019-10-14T09:03:22.563Z',
            },
            destination: {
        ...
        body: [
          {
            ...
            destination: {
              Config: {
                apiKey: '34d8efa09c5b048bbacc6af157f2e687',
                applicationId: 'O2YARRI15I',
                eventTypeSettings: [{ from: 'product list viewed', to: 'view' }],
              },
            },
          },
        ],
        ...
        body: [
          {
            message: {
              ...
              properties: {
                ...
                products: [
                  { objectId: 'ecommerce-sample-data-919', position: '7' },
                  { objectId: '9780439784542', position: 'a' },
                ],
                queryId: '43b15df305339e827f0ac0bdc5ebcaa7',
              },
              integrations: { All: true },
        ...
        body: [
          {
            ...
            destination: {
              Config: {
                apiKey: '34d8efa09c5b048bbacc6af157f2e687',
                applicationId: 'O2YARRI15I',
                eventTypeSettings: [{ from: 'product list viewed', to: 'check' }],
              },
            },
          },
        ],
        ...
        body: [
          {
            ...
            destination: {
              Config: { apiKey: '34d8efa09c5b048bbacc6af157f2e687', applicationId: 'O2YARRI15I' },
            },
          },
        ],
        method: 'POST',
