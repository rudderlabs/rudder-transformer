          ...
          input: [
            {
              ...
              metadata: { secret: { accessToken: SECRET_1 }, jobId: 1, userId: 'u1' },
              message: {
                userId: 'user 1',
                type: 'audiencelist',
                properties: {
            ...
            },
            {
              ...
              metadata: { secret: { accessToken: SECRET_1 }, jobId: 2, userId: 'u1' },
              message: {
                userId: 'user 1',
                type: 'audiencelist',
                properties: {
          ...
          output: [
            {
              ...
              metadata: [{ jobId: 1, secret: { accessToken: SECRET_1 }, userId: 'u1' }],
              batched: false,
              statusCode: 200,
              destination: {
                Config: {
            ...
            },
            {
              ...
              metadata: [{ jobId: 2, secret: { accessToken: SECRET_1 }, userId: 'u1' }],
              batched: false,
              statusCode: 200,
              destination: {
                Config: {
