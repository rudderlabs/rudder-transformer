...
describe("flattenJSon util test", () => {
  it("Test Case 1", () => {
    const outputArray = utilObj[fnName](PayloadInput1);
    expect(outputArray).toEqual(PayloadOutput1);
  });

  it("Test Case 2", () => {
    const outputArray = utilObj[fnName](PayloadInput2);
    expect(outputArray).toEqual(PayloadOutput2);
  });

  it("Test Case 3", () => {
    const outputArray = utilObj[fnName](PayloadInput3);
    expect(outputArray).toEqual(PayloadOutput3);
  });

  it("Test Case 4", () => {
    const outputArray = utilObj[fnName](PayloadInput4);
    expect(outputArray).toEqual(PayloadOutput4);
  });
});
