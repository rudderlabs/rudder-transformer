    ...
    input: {
      request: {
        body: {
          ...
          type: 'REST',
          method: 'PATCH',
          endpoint: 'https://api.criteo.com/2026-07/audiences/34894/contactlist',
          headers: {
    ...
    input: {
      request: {
        body: {
          ...
          type: 'REST',
          method: 'PATCH',
          endpoint: 'https://api.criteo.com/2026-07/audiences/3485/contactlist/expiredAccessToken',
          headers: {
            Authorization: defaultAccessTokenAuthHeader,
            'Content-Type': 'application/json',
            Accept: 'application/json',
              ...
              errors: [
                {
                  ...
                  instance: '/2026-07/audiences/123/contactlist',
    ...
    input: {
      request: {
        body: {
          ...
          type: 'REST',
          method: 'PATCH',
          endpoint: 'https://api.criteo.com/2026-07/audiences/34895/contactlist/invalidAccessToken',
          headers: {
            Authorization: defaultAccessTokenAuthHeader,
            'Content-Type': 'application/json',
            Accept: 'application/json',
    ...
    input: {
      request: {
        body: {
          ...
          type: 'REST',
          method: 'PATCH',
          endpoint: 'https://api.criteo.com/2026-07/audiences/34896/contactlist',
          headers: {
            Authorization: defaultAccessTokenAuthHeader,
            'Content-Type': 'application/json',
            Accept: 'application/json',
    ...
    input: {
      request: {
        body: {
          ...
          type: 'REST',
          method: 'PATCH',
          endpoint: 'https://api.criteo.com/2026-07/audiences/34897/contactlist',
          headers: {
            Authorization: defaultAccessTokenAuthHeader,
            'Content-Type': 'application/json',
            Accept: 'application/json',
    ...
    input: {
      request: {
        body: {
          ...
          type: 'REST',
          method: 'PATCH',
          endpoint: 'https://api.criteo.com/2026-07/audiences/34898/contactlist',
          headers: {
            Authorization: defaultAccessTokenAuthHeader,
            'Content-Type': 'application/json',
            Accept: 'application/json',
    ...
    input: {
      request: {
        body: {
          ...
          type: 'REST',
          method: 'PATCH',
          endpoint: 'https://api.criteo.com/2026-07/audiences/34899/contactlist',
          headers: {
            Authorization: defaultAccessTokenAuthHeader,
            'Content-Type': 'application/json',
            Accept: 'application/json',
