export const data = [
  ...
  {
    name: 'posthog',
    description: 'Batching Framework: Single alias event (no workspace env override)',
    feature: 'router',
    module: 'destination',
    version: 'v0',
    input: {
  ...
  },
  {
    name: 'posthog',
    description:
      'Batching Framework: Single track event Product Brought (no workspace env override)',
    feature: 'router',
    module: 'destination',
    version: 'v0',
    input: {
