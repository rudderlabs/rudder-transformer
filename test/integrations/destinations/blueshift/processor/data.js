    ...
    input: {
      request: {
        body: [
          {
            destination: {
              Config: { eventApiKey: 'efeb4a29aba5e75d99c8a18acd620ec1', dataCenter: 'standard' },
            },
            message: {
              channel: 'web',
              context: {
              ...
              traits: { groupType: 'company', name_trait: 'Company', value_trait: 'Comapny-ABC' },
            },
          },
        ],
        method: 'POST',
    ...
    input: {
      request: {
        body: [
          {
            destination: {
              Config: { usersApiKey: 'b4a29aba5e75d99c8a18acd920ec1e2e', dataCenter: 'standard' },
            },
            message: {
              type: 'track',
    ...
    input: {
      request: {
        body: [
          {
            destination: {
              Config: { eventApiKey: 'a5e75d99c8a18acb4a29abd920ec1e2e', dataCenter: 'eu' },
            },
            message: {
              channel: 'web',
              context: {
    ...
    input: {
      request: {
        body: [
          {
            destination: {
              Config: { usersApiKey: 'b4a29aba5e75duic8a18acd920ec1e2e', dataCenter: 'eu' },
            },
            message: {
              channel: 'web',
              context: {
