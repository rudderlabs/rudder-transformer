  ...
  },
  {
    ...
    output: {
      response: {
        ...
        body: [
          {
            error: 'Error while processing event: Error: Payload must be an valid object',
            statTags: {
  ...
  },
  {
    ...
    output: {
      response: {
        ...
        body: [
          {
            error: 'Error while processing event: Error: input event must have at least one field',
            statTags: {
              destinationId: 'Non determinable',
              errorCategory: 'transformation',
              implementation: 'native',
