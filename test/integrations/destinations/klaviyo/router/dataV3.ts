...
export const dataV3: RouterTestData[] = [
  {
    ...
    name: 'klaviyo',
    description: 'v3 router group subscribe with empty consent still sends subscriptions object',
    scenario: 'Framework',
    successCriteria:
      'Output should keep v3 revision and include subscriptions: {} in the bulk subscribe payload',
    feature: 'router',
    module: 'destination',
    version: 'v0',
    input: {
