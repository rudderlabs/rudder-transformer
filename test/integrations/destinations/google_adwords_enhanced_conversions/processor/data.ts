...
export const data = [
  ...
  {
    name: 'google_adwords_enhanced_conversions',
    description: 'Success test with configData but subAccount false',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
        ...
        body: [
          {
            ...
            destination: {
              Config: {
                ...
                authStatus: 'active',
                subAccount: false,
                configData: '{"customerId": "1234567890"}',
                customerId: '1234567890',
  ...
  {
    name: 'google_adwords_enhanced_conversions',
    description: 'Success test with configData',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
        ...
        body: [
          {
            ...
            destination: {
              Config: {
                ...
                authStatus: 'active',
                subAccount: false,
                configData: '{"customerId": "1234567890", "loginCustomerId": "54321"}',
                customerId: '1234567890',
                loginCustomerId: '12345',
              },
            },
