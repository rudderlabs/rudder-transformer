...
const eventValidationTestCases = [
    ...
    {
        "testCase": "Track is part of Tracking Plan + no track config and unplannedProperties is set to drop",
        "event": {
            metadata: {
                trackingPlanId: "dummy_tracking_plan_id",
                trackingPlanVersion: "dummy_version",
    ...
    {
        "testCase": "Track is part of Tracking Plan + no global config and unplannedProperties is set to forward",
        "event": {
            metadata: {
                trackingPlanId: "dummy_tracking_plan_id",
                trackingPlanVersion: "dummy_version",
