...
import { PluginAdapter } from '../../helpers/pluginAdapter';
import {
  DeliveryV0Response,
  DeliveryV1Response,
  ErrorDetailer,
...
export class PluginIntegrationService implements DestinationService {
  ...
  public doBatchTransformation(
    ...
    throw new TransformationError('Plugin Framework Does not Implement Batch Transform Routine');
  }
  ...
  public deliver(
    ...
    throw new TransformationError('Plugin Framework Does not Implement Delivery Routine');
  }
  ...
  public processUserDeletion(
    ...
    throw new TransformationError('Plugin Framework Does not Implement Deletion Routine');
  }
}
