				...
				"body": [
					{
						"message": {
							...
							"messageId": "node-6f62b91e789a636929ca38aed01c5f6e-103c720d-81bd-4742-98d6-d45a65aed23e",
							"properties": {
				...
				"body": [
					...
					},
					{
						"output": {
							...
							"body": {
								"JSON": {
									"browserToken": "some_device_token",
									"email": "ruchira@rudderlabs.com",
									"userId": "123456"
								},
								"XML": {},
						...
						"output": {
							...
							"body": {
								"JSON": {
									...
									"device": {
										"token": "sample_push_token",
										"applicationName": "sample_device_name",
										"platform": "APNS"
									},
									"preferUserId": true
								},
				...
				"body": [
					{
						"message": {
							...
							"context": {
								...
								"campaign": {},
								"userAgent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.1.1 Safari/605.1.15"
							},
