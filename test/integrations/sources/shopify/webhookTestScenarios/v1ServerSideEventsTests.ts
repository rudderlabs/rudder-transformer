...
export const v1ServerSideEventsScenarios = [
  ...
  },
  {
    id: '002',
    name: 'shopify',
    description: 'Track Call -> Cart Update event with multiple line items',
    module: 'source',
    version: 'v1',
    input: {
      request: {
  ...
  },
  {
    id: '003',
    name: 'shopify',
    description: 'Track Call -> Cart Update event with no line items',
    module: 'source',
    version: 'v1',
    input: {
      request: {
  ...
  },
  {
    id: '004',
    name: 'shopify',
    description: 'Track Call -> Checkout Started event',
    module: 'source',
    version: 'v1',
    input: {
      request: {
  ...
  },
  {
    id: '005',
    name: 'shopify',
    description: 'Identify Call -> Customer update event',
    module: 'source',
    version: 'v1',
    input: {
      request: {
            ...
            event: {
              ...
              addresses: [
                ...
                },
                {
                  ...
                  last_name: 'waffles',
                  company: null,
                  address1: 'Fancy Point Entergy Power Station',
                  address2: 'point gun villas',
                ...
                },
                {
                  ...
                  last_name: 'waffles',
                  company: null,
                  address1: 'Tansy Point',
                  address2: 'gun point range villas',
                  city: 'Warrenton',
                  province: 'Oregon',
                  country: 'United States',
                  zip: '97146',
  ...
  },
  {
    id: '006',
    name: 'shopify',
    description: 'Track Call -> Order Updated event',
    module: 'source',
    version: 'v1',
    input: {
      request: {
  ...
  },
  {
    id: '007',
    name: 'shopify',
    description: 'Track Call -> Order Created event',
    module: 'source',
    version: 'v1',
    input: {
      request: {
