export const data = [
  ...
  },
  {
    name: 'google_adwords_remarketing_lists',
    description:
      'Test 20 : consent field values are set to UNKNOWN if it does not match allowed values',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
  ...
  },
  {
    name: 'google_adwords_remarketing_lists',
    description:
      'Test 21 : user data is grouped based on consent field values and sent to google ads api',
    feature: 'processor',
    module: 'destination',
    version: 'v0',
    input: {
