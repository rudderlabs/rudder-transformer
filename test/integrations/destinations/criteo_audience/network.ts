...
export const networkCallsData = [
  {
    httpReq: {
      url: 'https://api.criteo.com/2026-07/audiences/34894/contactlist',
      data: {
        data: {
          type: 'ContactlistAmendment',
          attributes: {
  ...
  {
    httpReq: {
      url: 'https://api.criteo.com/2026-07/audiences/34893/contactlist',
      data: {
        data: {
          type: 'ContactlistAmendment',
          attributes: {
  ...
  {
    httpReq: {
      url: 'https://api.criteo.com/2026-07/audiences/34896/contactlist',
      data: commonData,
      params,
      headers,
      method,
  ...
  {
    httpReq: {
      url: 'https://api.criteo.com/2026-07/audiences/34897/contactlist',
      data: commonData,
      params,
      headers,
      method,
  ...
  {
    httpReq: {
      url: 'https://api.criteo.com/2026-07/audiences/34898/contactlist',
      data: commonData,
      params,
      headers,
      method,
  ...
  {
    httpReq: {
      url: 'https://api.criteo.com/2026-07/audiences/34899/contactlist',
      data: commonData,
      params,
      headers,
      method,
