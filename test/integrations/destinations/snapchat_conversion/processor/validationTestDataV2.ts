...
export const validationTestDataV2: ProcessorTestData[] = [
  {
        ...
        body: [
          {
            ...
            metadata,
            destination: overrideDestination(destination, { pixelId: null }),
          },
        ],
      },
    },
  ...
  },
  {
    id: 'processor-1746381267903',
    name: 'snapchat_conversion',
    description: 'Test case with unavailable required field',
    scenario: 'Default processor scenario',
    successCriteria: 'Processor test should fail',
    feature: 'processor',
    module: 'destination',
  ...
  },
  {
    id: 'processor-1746381267903',
    name: 'snapchat_conversion',
    description: 'Test case without message type',
    scenario: 'Default processor scenario',
    successCriteria: 'Processor test should fail',
    feature: 'processor',
    module: 'destination',
