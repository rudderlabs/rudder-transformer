...
const getTestMessage = () => {
  ...
  let userIdentifierInfo = {
    email: "testEmail",
    phone: "testPhone",
    address:{"city": "kolkata", "country_code": "IN", "hashed_first_name": "37d80f43f43cd48f2e363a2d1f2aee343d7ba0a12a6227ee17b4ef3ede78c204", "hashed_last_name": "6ee08e6eb3bc6f45bc99fcd39fcc479286a1beb0c04d39f204c61762378075d6", "postal_code": "700114"}
  };
...
describe('buildAndGetAddress util tests', () =>{
    it('hashUserIdentifier as true',() => {
        expectedOutput = {"city": "kolkata", "country_code": "IN", "hashed_first_name": "37d80f43f43cd48f2e363a2d1f2aee343d7ba0a12a6227ee17b4ef3ede78c204", "hashed_last_name": "6ee08e6eb3bc6f45bc99fcd39fcc479286a1beb0c04d39f204c61762378075d6", "postal_code": "700114"}
        expect(buildAndGetAddress(getTestMessage(), true)).toEqual(expectedOutput)
    }) 
    it('hashUserIdentifier as false',() => {
        expectedOutput = {"city": "kolkata", "country_code": "IN", "hashed_first_name": "rudder", "hashed_last_name": "stack", "postal_code": "700114"}
...
describe('getExisitingUserIdentifier util tests', () =>{
    ...
    it('getExisitingUserIdentifier when default identifier is email and phone is absent',() => {
        fittingPayload = {...userIdentifierInfo};
...
describe('getClickConversionPayloadAndEndpoint util tests', () =>{
    it('getClickConversionPayloadAndEndpoint flow check when default field identifier is present',() => {
        expectedOutput = {"endpoint": "https://googleads.googleapis.com/v13/customers/9625812972:uploadClickConversions", "payload": {"conversions": [{"conversionDateTime": "2022-01-01 12:32:45-08:00", "conversionEnvironment": "WEB", "userIdentifiers": [{"hashedEmail": "fa922cb41ff930664d4c9ced3c472ce7ecf29a0f8248b7018456e990177fff75", "userIdentifierSource": "THIRD_PARTY"}]}]}}
        expect(getClickConversionPayloadAndEndpoint(getTestMessage(), config, "9625812972")).toEqual(expectedOutput)
    }) 
    ...
    it('getClickConversionPayloadAndEndpoint flow check when default field identifier is absent',() => {
        ...
        expect(getClickConversionPayloadAndEndpoint(fittingPayload, config, "9625812972")).toEqual(expectedOutput)
    })
    ...
    it('getClickConversionPayloadAndEndpoint flow check when both email and phone are absent',() => {
        ...
        delete fittingPayload.properties.email;
        expectedOutput = {"endpoint": "https://googleads.googleapis.com/v13/customers/9625812972:uploadClickConversions", "payload": {"conversions": [{"conversionDateTime": "2022-01-01 12:32:45-08:00", "conversionEnvironment": "WEB", "userIdentifiers": [{"hashedPhoneNumber": "2e0da1dbea5e4dc3ef73fde4de9329dd19f9030b384c169ff776002f45fd9a32", "userIdentifierSource": "THIRD_PARTY"}]}]}}
        expect(()=>getClickConversionPayloadAndEndpoint(fittingPayload, config, "9625812972")).toThrow('Either of email or phone is required for user identifier')
    })
