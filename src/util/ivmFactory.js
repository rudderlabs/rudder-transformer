...
const { injectV1SandboxApis, V1_FORWARD_MAIN_PROMISE_SOURCE } = require('./ivm/sandboxBridge');
...
async function createIvm(
  ...
  const bootstrap = await isolate.compileScript(V1_FORWARD_MAIN_PROMISE_SOURCE);
