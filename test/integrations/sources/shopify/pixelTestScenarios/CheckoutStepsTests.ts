import { dummySourceConfig, dummyContext, responseDummyContext } from '../constants';

export const pixelCheckoutStepsScenarios = [
  {
    name: 'shopify',
        ...
        body: [
          {
            output: {
              batch: [
                {
                  context: { ...responseDummyContext, topic: 'checkout_address_info_submitted' },
                  integrations: {
                    SHOPIFY: true,
                  },
                  type: 'track',
        ...
        body: [
          {
            output: {
              batch: [
                {
                  context: { ...responseDummyContext, topic: 'checkout_contact_info_submitted' },
                  integrations: {
                    SHOPIFY: true,
                  },
                  type: 'track',
        ...
        body: [
          {
            output: {
              batch: [
                {
                  context: { ...responseDummyContext, topic: 'checkout_shipping_info_submitted' },
                  integrations: {
                    SHOPIFY: true,
                  },
                  type: 'track',
        ...
        body: [
          {
            output: {
              batch: [
                {
                  context: { ...responseDummyContext, topic: 'payment_info_submitted' },
                  integrations: {
                    SHOPIFY: true,
                  },
                  type: 'track',
